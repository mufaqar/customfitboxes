...
const Footer = () => {
    return (
        <footer className='border-t border-zinc-300 md:pt-5'>
            <div className='container mx-auto   grid md:grid-cols-4 grid-cols-1 gap-y-14 border-b border-zinc-200 pb-14 pt-10 md:gap-y-0 gap-x-0 md:gap-x-5 lg:gap-x-8'>
            ...
            <div className='container mx-auto   flex flex-col items-center justify-between gap-y-3 py-12 md:flex-row md:gap-y-0 md:gap-x-4'>
