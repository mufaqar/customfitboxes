        ...
        <section className='pb-14 pt-5'>
            <div className='container mx-auto  '>
                ...
                <p className='text-base leading-5 text-center mt-1'>
                    At Custom Fit Boxes, we specialize in crafting innovative, high-quality packaging solutions that enhance brand identity. <br className='hidden sm:block' />
            ...
            <div className='container mx-auto flex md:flex-row flex-col gap-8 items-center mt-10'>
                <div className='md:w-1/2 w-full text-lg text-desc/80'>
                    ...
                    <Link href="/about-us" className='lg:text-xl text-base font-normal text-white hover:text-primary border border-white hover:border-primary bg-primary hover:bg-transparent rounded-md px-4 whitespace-nowrap lg:h-14 h-12 duration-300 inline-flex items-center justify-between gap-8 md:mt-14 mt-8'>
                        About Us <Image src="/images/chevron.svg" alt='chevron' width={40} height={40} />
                    </Link>
                </div>
